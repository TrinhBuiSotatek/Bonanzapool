...
|---|---|---|---|---|---|---|
| UC-EXBOT-bot-start | `uc-bot-start.md` | System (key-provision worker), ExBot Worker, BnzaExVault, HL | Start ExBot: deposit → key-provision → preflight → LP mint → hedge open → stop place → active | US-EXBOT-001 | FR-001,002,003,004,020,030,031 | unknown |
...
| UC-EXBOT-deep-audit | `uc-deep-audit.md` | ExBot System Operator (Deep-Audit Worker), HL | 6h/1h full HL reconcile: mismatch → SAFE_MODE, stuck markers → SAFE_MODE, margin update | US-EXBOT-005, US-EXBOT-008, US-EXBOT-010 | FR-016,033 | unknown |
