...
> **Scenarios:** UC-EXBOT-bot-safe-close_bot-safe-close_scenarios_20260707_v3.md
> **Generated:** 2026-07-02
> **Updated:** 2026-07-07 (v2: **Q9 RE-OPENED (Medium — CẦN CONFIRM TỪ BA)**, Q4 open (CẦN CONFIRM TỪ BA))
...
|---|---|---|---|
| Close Worker role clarification: actor vs architecture (**Q4 — CẦN CONFIRM TỪ BA**) | UC §1 lists "Close Worker" as Primary Actor, nhưng evidence cho thấy nó là architecture component (ExBot Lambda). BA cần confirm role definition và update UC §1 nếu cần. Trigger mechanism (5 conditions from other workers + admin API) đã được document nhưng chưa được confirm trong UC. | **Chờ Q4 answer từ BA** | TC_003, TC_004, TC_020 |
