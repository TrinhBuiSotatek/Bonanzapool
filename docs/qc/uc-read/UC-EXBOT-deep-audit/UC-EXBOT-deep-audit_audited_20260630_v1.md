...
|---|---|---|---|
| `uc-deep-audit.md` | updated 2026-07-02 | UC under review — updated với E-code references (E-EXBOT-019, E-EXBOT-020) | Primary source |
| `srs/spec.md` | updated 2026-06-29 | SRS baseline — FR-EXBOT-016, FR-EXBOT-033 | Source of truth for deep-audit |
| `srs/states.md` | updated 2026-07-02 | State registry — updated với paused bot note cho stuck marker (row 71) | Baseline |
...
| `message-list.md` | updated 2026-07-01 | E-EXBOT-019, E-EXBOT-020 definitions cho stuck marker notifications | E-codes confirmed |
...
|---|---|---|
| qc-notes-temp.md | 2026-07-02 | BA trả lời Q-DA-01 (E-EXBOT-019/020), Q-DA-02 (paused bot stuck marker) |
| message-list.md | 2026-07-01 | E-EXBOT-019, E-EXBOT-020 added |
| uc-deep-audit.md | 2026-07-02 | A4 updated với E-code references |
| srs/states.md | 2026-07-02 | Row 71 updated với stuck marker note |
...
| 3.5. SAFE_MODE entry condition | UC định nghĩa 3 entry paths: mismatch (A3), stop_trigger_crossed_at stuck > 30min (A4, E-EXBOT-019), stop_replacing_started_at stuck > 60s (A4, E-EXBOT-020) | Yes | Bot enters safe_mode; admin notified | N/A | FR-EXBOT-050 |
...
| stop_trigger_crossed_at stuck | Admin escalation notification | E-EXBOT-019: "Stop trigger marker stuck for over 30 minutes. Bot entered Safe Mode. Manual review required." | E-EXBOT-019 | UC A4; message-list.md row 364 |
| stop_replacing_started_at stuck | Admin escalation notification | E-EXBOT-020: "Stop replacement marker stuck for over 60 seconds. Bot entered Safe Mode. Manual review required." | E-EXBOT-020 | UC A4; message-list.md row 365 |
...
## 11. Issue Register (Updated 2026-07-02)

### Issue Summary

| Issue ID | Type | Severity | Affected Area | Finding | Status |
|---|---|---|---|---|---|
| I-DA-01 | ~~MISSING_INFO~~ **CONFIRMED** | ~~Major~~ **Resolved** | Area 2: Data Object Validation & Messages | ~~Admin notification messages cho stuck marker cases không được định nghĩa — no E-code, no message content~~ **Đã resolved:** E-EXBOT-019 và E-EXBOT-020 đã được thêm vào message-list.md (2026-07-01). UC A4 đã updated với E-code references. | **Resolved** |
| I-DA-02 | ~~UNCLEAR_INFO~~ **CONFIRMED** | ~~Medium~~ **Resolved** | Area 2: Business Rules | ~~Không verify stopped marker detection hoạt động đúng cho paused bot~~ **Đã resolved:** UC A2 và states.md row 71 đã updated. Stuck marker detection chạy cho paused bot; transition là `paused → safe_mode`. | **Resolved** |
...
| I-DA-04 | UNCLEAR_INFO | Low | Area 2: Business Rules | Cadence switching mechanism (6h→1h) được ghi vào đâu trong D1 chưa rõ. | Open |

### Issue Details

**I-DA-01 — ~~MISSING_INFO~~ **RESOLVED** (Medium)**
...
**Suggested question/fix:** ~~Tech Lead xác nhận: (1) Worker update `bots.next_deep_audit_at` khi cadence switch, hay (2) Cron worker tự switch schedule dựa trên state query mà không cần ghi D1.~~ **Resolved.**
...
### Scoring Summary (Updated 2026-07-02)

| Scoring Area | Max Points | Score v1 | Score v2 | Status |
|---|---|---|---|---|
| Area 1: Function / Operation & Data Object Inventory | 20 | 15/20 ⚠️ Partial | **18/20 ✅ Clear** | Updated |
| Area 2: Data Object / State Attributes, Business Rules, Validations & Messages | 25 | 17/25 ⚠️ Partial | **23/25 ✅ Clear** | Updated |
| Area 3: Functional Logic & Workflow Decomposition | 25 | 20/25 ⚠️ Partial | **23/25 ✅ Clear** | Updated |
| Area 4: Functional Integration & Data Consistency | 15 | 12/15 ✅ Clear | **13/15 ✅ Clear** | Minor update |
| Area 5: UC / Spec Documentation Quality Issues | 15 | 10/15 ⚠️ Partial | **13/15 ✅ Clear** | Updated |
| **Total** | **100** | **74/100** | **90/100** | **↑ +16** |
| **Verdict** | — | ⚠️ Conditionally Ready | **✅ Ready** | ↑ |

**Changes from v1:**
- I-DA-01 (E-code missing) → Resolved: E-EXBOT-019, E-EXBOT-020 confirmed
- I-DA-02 (paused bot stuck marker) → Resolved: UC A2 and states.md updated
- I-DA-03 (Shard iteration) → Open: Tech Lead decision, Phase A unaffected
- I-DA-04 (Cadence switching) → Open: Tech Lead decision, Phase A unaffected

**Verdict:** ✅ **Ready (90-100).** UC-EXBOT-deep-audit đã sẵn sàng cho test design. Các issue còn lại (I-DA-03, I-DA-04) là Tech Lead decisions hoặc áp dụng cho Phase B, không block test design hiện tại.
...
*UC-EXBOT-deep-audit Readiness Review Report - v1 (updated in-place 2026-07-02)*
